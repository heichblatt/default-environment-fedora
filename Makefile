...
all: rpmfusion base web flash kde communication pidgin-window-merge kde-extras office msfonts media docker devel latex 
...
base:
	...
	$(INSTALL) transmission-remote-gtk iftop iotop htop vim git etckeeper keepassx nmap kupfer yum-plugin-remove-with-leaves trash-cli wget net-tools nmap-frontend wireshark sudo nmon ike zsh terminus-fonts cryptkeeper
